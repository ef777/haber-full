  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Yazar Profil */}
        <div className="bg-white dark:bg-[#141414] rounded-lg border border-gray-200 dark:border-[#262626] p-6 mb-8">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            {yazar.avatar ? (
              <Image
                ...
                width={150}
                height={150}
                className="rounded-full object-cover ring-4 ring-gray-100 dark:ring-[#262626]"
                unoptimized={yazar.avatar.includes('/uploads/')}
              />
            ) : (
              <div className="w-36 h-36 bg-gray-100 dark:bg-[#0a0a0a] rounded-full flex items-center justify-center text-4xl text-gray-500 dark:text-gray-500 ring-4 ring-gray-100 dark:ring-[#262626]">
                {yazar.ad.charAt(0)}
              </div>
            )}
            <div className="flex-1 text-center md:text-left">
              ...
              {yazar.biyografi && (
                <p className="text-gray-500 dark:text-gray-400 mb-4">{yazar.biyografi}</p>
              )}
              <div className="flex gap-4 justify-center md:justify-start">
                {yazar.twitter && (
                  <a
                    ...
                    className="text-gray-500 dark:text-gray-500 hover:text-[#1DA1F2] transition-colors"
                  >
                ...
                {yazar.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-500 dark:text-gray-500 hover:text-[#0A66C2] transition-colors"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {yazar.website && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-500 dark:text-gray-500 hover:text-red-500 transition-colors"
                  >
              ...
              <p className="text-gray-400 dark:text-gray-500 mt-4">
                Toplam <span className="font-semibold text-gray-600 dark:text-gray-300">{totalCount}</span> haber yazıldı
              </p>
            </div>
          </div>
        </div>
