    ...
    <>
      ...
      <article className="container mx-auto px-4 py-8" data-main-article>
        ...
        <nav className="mb-6 text-sm">
          <ol className="flex items-center gap-2 text-gray-500 dark:text-gray-500">
            <li>
            ...
            <li className="text-gray-700 dark:text-gray-300 truncate max-w-xs">{haber.baslik}</li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <header className="mb-6">
              ...
              {haber.spot && (
                <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 mb-6 leading-relaxed font-light">
                  {haber.spot}
                </p>
              )}
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 text-sm text-gray-500 dark:text-gray-500 border-t border-b border-gray-200 dark:border-[#262626] py-4">
                ...
                <div className="flex flex-col text-right">
                    <time dateTime={haber.yayinTarihi.toISOString()} className="text-gray-600 dark:text-gray-400 font-medium">
            ...
            {haber.etiketler.length > 0 && (
              <div className="mb-8">
                <span className="text-sm font-semibold text-gray-500 dark:text-gray-500 mb-2 block uppercase tracking-wider">Etiketler:</span>
